      ...
      <label style={{ cursor: 'pointer', padding: 15, borderRadius: 3, justify: "center", }}>
        {
          isRejected?
            ...
            <div className='container'>
              <div>
                <h3>Drag and drop your videos</h3>
                <p>or</p>
              </div>
              <br/>
              <label className='rounded' for="upload">Add Video</label>
            </div>
        }
        <input
          style={{ display: 'none' }}
  ...
  return (
    <React.Fragment>
      ...
      <div style={{ textAlign:'center' }}>
        <button className='rounded' style={{ display: "inline-block" }}>Cancel</button>&nbsp;
        <button className='rounded-plein' style={{ display: "inline-block" }}>Save</button>
      </div>
